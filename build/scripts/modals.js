...
$(document).ready(function () {
  window.modals = {
    ...
    methods: {
      ...
      _stop_propgagation: function _stop_propgagation(e) {
        e.stopPropagation();
      },
      // Opens a modal
      ...
      _nav_to_adjacent: function _nav_to_adjacent(direction) {
        var $active_modal = window.modals.elements.modal.filter('.active'),
      ...
      _resize_fix: function _resize_fix() {
        var $active_modal = window.modals.elements.modal.filter('.active'),
            $overlay = $active_modal.find('.modal-overlay'),
            $nav = $active_modal.find('.modal-nav'),
            $body_wrap = $active_modal.find('.modal-body-wrap'),
