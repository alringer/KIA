  ...
  window.dial = {
    ...
    methods: {
      ...
      _adjust_ui: function _adjust_ui(c, v) {
        ...
        props.handle.css({
          transform: "rotate(".concat(degree, "deg) translate(-").concat(adjust_by, "px) rotate(").concat(-degree, "deg)")
        });
        props.pin.css({
          transform: "rotate(".concat(degree - 90, "deg)")
        });
      ...
      _set: function _set(c, v) {
        ...
        clearTimeout(window["settingDialClass".concat(c)]);
        props.element.addClass('setting');

        window.dial.methods._adjust_ui(c, adjust_v);

        window["settingDialClass".concat(c)] = setTimeout(function () {
